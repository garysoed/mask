...
import { B010, B050, B075, B100, B150, B175, B200, Shade } from './shade';
...
export const DARK_SHADING = new Map<ColorSection, ShadingSpec>([
  ...
  [
    ColorSection.ACTION,
    {bg: B010, accent: false, primary: Alpha.HIGH, secondary: Alpha.MEDIUM, shade: B150},
  ],
  [
    ColorSection.ACTION_FOCUS,
    {bg: B075, accent: true, primary: Alpha.HIGH, secondary: Alpha.MEDIUM, shade: B150},
  ],
  [
    ColorSection.ACTION_DISABLED,
...
export const HIGHLIGHT_DARK_SHADING = new Map<ColorSection, ShadingSpec>([
  ...
  [
    ColorSection.ACTION,
    {bg: B075, accent: false, primary: Alpha.HIGH, secondary: Alpha.MEDIUM, shade: B150},
  ],
  [
    ColorSection.ACTION_FOCUS,
    {bg: B075, accent: true, primary: Alpha.HIGH, secondary: Alpha.MEDIUM, shade: B150},
  ...
  [
    ColorSection.ACTION_PRIMARY_DISABLED,
    {bg: B075, accent: false, primary: Alpha.LOW, secondary: Alpha.LOW, shade: B150},
  ],
]);
